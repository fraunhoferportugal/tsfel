...
def test_lpcc():
    ...
    np.testing.assert_almost_equal(lpcc(lin0), (0.14693248468111308, 0.7098379679548503, 0.27136979375401815,
                                                ...
                                                0.7098379679548503))
    np.testing.assert_almost_equal(lpcc(wave), (0.27326496625409336, 2.250351320633344, 1.312040836088298,
                                                0.9508374450696984, 0.8377304872545823, 0.7195727297050777,
                                                0.7152391338500754, 0.7152391338500754, 0.7195727297050777,
                                                0.8377304872545823, 0.9508374450696984, 1.312040836088298,
                                                2.250351320633344))
