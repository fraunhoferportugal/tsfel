...
class TestFeatures(unittest.TestCase):
    ...
    def test_ecdf_percentile(self):
        ...
        np.testing.assert_almost_equal(ecdf_percentile(lin0), (-6.8421053, 5.7894737), decimal=7)
    ...
    def test_med_fre(self):
        ...
        np.testing.assert_almost_equal(median_frequency(noiseWave, Fs), 146.0, decimal=1)
    ...
    def test_spectral_centroid(self):
        ...
        np.testing.assert_almost_equal(spectral_centroid(lin, Fs), 96.7073273343592, decimal=5)
        np.testing.assert_almost_equal(spectral_centroid(lin0, Fs), 186.91474845748346, decimal=5)
        np.testing.assert_almost_equal(spectral_centroid(wave, Fs), 5.000000000003773, decimal=5)
        np.testing.assert_almost_equal(spectral_centroid(offsetWave, Fs), 1.0000000000008324, decimal=5)
        np.testing.assert_almost_equal(spectral_centroid(noiseWave, Fs), 181.0147784750644, decimal=5)
    ...
    def test_spectral_spread(self):
        ...
        np.testing.assert_almost_equal(spectral_spread(offsetWave, Fs), 2.0000000000692015, decimal=5)
        np.testing.assert_almost_equal(spectral_spread(noiseWave, Fs), 165.48999545678365, decimal=5)
    ...
    def test_spectral_skewness(self):
        ...
        np.testing.assert_almost_equal(spectral_skewness(lin0, Fs), 0.8056481576984844, decimal=5)
    ...
    def test_spectral_kurtosis(self):
        ...
        np.testing.assert_almost_equal(spectral_kurtosis(lin0, Fs), 2.378341102603641, decimal=5)
        ...
        np.testing.assert_almost_equal(spectral_kurtosis(noiseWave, Fs), 1.7248024846010621, decimal=5)
    ...
    def test_spectral_decrease(self):
        ...
        np.testing.assert_almost_equal(spectral_decrease(lin0, Fs), 0.49895105698521264, decimal=5)
        ...
        np.testing.assert_almost_equal(spectral_decrease(noiseWave, Fs), 0.06049066756953234, decimal=5)
    ...
    def test_spectral_distance(self):
        ...
        np.testing.assert_almost_equal(spectral_distance(wave, Fs), -122750.0, decimal=1)
    ...
    def test_spect_variation(self):
        ...
        np.testing.assert_almost_equal(spectral_variation(lin0, Fs), 0.3930601189429277, decimal=5)
    ...
    def test_spectral_positive_turning(self):
        ...
        np.testing.assert_almost_equal(spectral_positive_turning(wave, Fs), 161, decimal=0)
    ...
    def test_lpcc(self):
        ...
        np.testing.assert_almost_equal(lpcc(const1), ((0.04123300285294014, 1.0090886040206166, 0.5477967308058846,
                                                       0.38934442309407374, 0.3182978464880446, 0.28521488787857235,
                                                       0.2753824147772057, 0.2852148878785723, 0.3182978464880446,
                                                       0.3893444230940738, 0.5477967308058846, 1.0090886040206166)))
        np.testing.assert_almost_equal(lpcc(constNeg), (0.04123300285294014, 1.0090886040206166, 0.5477967308058846,
                                                        0.38934442309407374, 0.3182978464880446, 0.28521488787857235,
                                                        0.2753824147772057, 0.2852148878785723, 0.3182978464880446,
                                                        0.3893444230940738, 0.5477967308058846, 1.0090886040206166))
        np.testing.assert_almost_equal(lpcc(constF), (0.04123300285293459, 1.0090886040206097, 0.54779673080588,
                                                      0.3893444230940775, 0.31829784648804227, 0.2852148878785703,
                                                      0.2753824147772089, 0.28521488787857036, 0.31829784648804227,
                                                      0.3893444230940775, 0.54779673080588, 1.0090886040206097))
        np.testing.assert_almost_equal(lpcc(lin), (0.0008115287870079275, 0.949808211511519, 0.469481269387107,
                                                   0.31184557567242355, 0.24105584503772784, 0.2081345982990198,
                                                   0.198356078000162, 0.2081345982990197, 0.24105584503772784,
                                                   0.31184557567242355, 0.469481269387107, 0.9498082115115191))
        np.testing.assert_almost_equal(lpcc(lin0), (0.14900616258072136, 0.7120654174490035, 0.28220640800360736,
                                                    0.13200549895670105, 0.0674236160580709, 0.03817662578918231,
                                                    0.029619974765142276, 0.03817662578918224, 0.0674236160580709,
                                                    0.13200549895670105, 0.28220640800360736, 0.7120654174490035))
        np.testing.assert_almost_equal(lpcc(wave), (0.3316269831953852, 2.2936534454791397, 1.3657365894469182,
                                                    1.0070201818573588, 0.8468783257961441, 0.8794963357759213,
                                                    0.6999667686345086, 0.8794963357759211, 0.8468783257961441,
                                                    1.0070201818573588, 1.3657365894469182, 2.2936534454791397))
        np.testing.assert_almost_equal(lpcc(offsetWave), (0.6113077446051783, 1.650942970269406, 1.191078896704431,
                                                          1.0313503136863278, 0.9597088652698047, 0.9261323880465244,
                                                          0.9160979308646922, 0.9261323880465244, 0.9597088652698047,
                                                          1.031350313686328, 1.1910788967044308, 1.650942970269406))
        np.testing.assert_almost_equal(lpcc(noiseWave), (0.3907899246825849, 0.6498327698888337, 0.7444466184462464,
                                                         0.7833967114468317, 0.7517838305481447, 0.7739966761714876,
                                                         0.8210271929385791, 0.7739966761714876, 0.7517838305481447,
                                                         0.7833967114468317, 0.7444466184462464, 0.6498327698888338))
    ...
    def test_spectral_entropy(self):
        ...
        np.testing.assert_almost_equal(spectral_entropy(noiseWave, Fs), 0.0301141821499739)
