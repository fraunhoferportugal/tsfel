...
project = "TSFEL"
copyright = "2021, Fraunhofer AICOS"
...
latex_documents = [
    (master_doc, "TSFEL.tex", "TSFEL Documentation", "Fraunhofer AICOS", "manual"),
]
...
man_pages = [(master_doc, "tsfel", "TSFEL Documentation", [author], 1)]
